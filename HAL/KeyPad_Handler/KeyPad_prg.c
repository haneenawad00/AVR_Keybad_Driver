...
extern u8 KEYPAD_u8aKeyPadMap_Lock[4][4];
...
{
	Local_u8PressedSwitch = KEYPAD_u8aKeyPadMap_Lock[Local_u8CurrentRow-KEYPAD_ROW_START][Local_u8CurrentCol-KEYPAD_COLUMN_START] ;
